...
cubicQ a b c = ((3 * a * c) - (b *** 2)) / (9 * (a *** 3))

{- -----------------------------------------------------------------
 - cubicR
 - -----------------------------------------------------------------
 - Description:
 -   cubicR takes in 4 Double parameters - a, b, c, and d - and returns a Double value that is used in conjunction with the value from cubicQ to calculate the discriminant
 -}
...
cubicS q r = let discrim = q***3 + r***2
             in cbrt ( r + discrim***(1/2) )
